function [points, EV] = opt_simple (u, X, Y, space_parameters, F1, F2)
...
[points, EV] = opt_ka_simple (u, 1, 1, X, Y, space_parameters, F1, F2);
for a = 1 : size(u, 2)
for k = 1 : 2
    [points_, EV_] = opt_ka_simple (u, k, a, X, Y, space_parameters, F1, F2);
